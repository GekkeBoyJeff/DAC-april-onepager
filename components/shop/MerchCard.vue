<template>
  <div
    class="group relative bg-gradient-to-br from-dark-800 to-dark-900 rounded-lg border border-dark-700 transition-all duration-300 md:hover:border-primary-600/50 md:hover:shadow-xl md:hover:shadow-primary-900/40 md:hover:-translate-y-2 md:hover:scale-[1.02] hover:cursor-hook"
  >

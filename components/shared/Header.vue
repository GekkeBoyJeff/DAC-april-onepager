  ...
  <header class="sticky top-0 z-40 w-full backdrop-blur-md bg-dark-900/80 border-b border-primary-700/30">
    <div class="container mx-auto px-4 h-20 sm:h-22">
      <div class="h-full flex items-center justify-between gap-4 lg:gap-8">
        ...
        <nav class="hidden md:flex items-center gap-3 lg:gap-6 xl:gap-8 flex-1 justify-center">
          <a
        ...
        <div class="flex items-center gap-3">
          <a
            ...
            class="hidden md:inline-flex items-center gap-2 px-3 lg:px-4 py-2 rounded-lg bg-primary-600/20 text-primary-300 hover:bg-primary-600/40 border border-primary-600/40 hover:border-primary-500/60 transition-all duration-300 text-xs lg:text-sm font-medium group whitespace-nowrap"
          >
